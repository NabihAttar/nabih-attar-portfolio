    ...
    <MotionSection className="py-14 sm:py-24">
      <Container>
        ...
        <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
          <AnimatedCard as="div" className="rounded-3xl border border-white/10 bg-white/5 p-6">
            ...
            <div className="mt-5 space-y-4">
              {education.map((item, index) => (
                <Reveal key={item.institution} as="div" delay={0.1 + index * 0.05} className="rounded-2xl border border-white/10 bg-slate-950/60 p-5">
          ...
          <AnimatedCard as="div" className="rounded-3xl border border-white/10 bg-white/5 p-6" delay={0.08}>
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-cyan-400/10 text-cyan-300">
              <Award size={22} />
            </div>
